...
@Tag(name = "订单管理", description = "相关的API接口")
@Validated
public class OrdersController {
    ...
    public ApiResultResponse<List<Orders>> list() {
    ...
    @ApiOperationSupport(author = "zpc")
    public ApiResultResponse<List<OrdersVo>> page(@ParameterObject OrderListParams  orderListParams) {
        Page<OrdersVo> page = orderListParams.toMapPage();
        QueryWrapper<Orders> queryWrapper = new QueryWrapper<>();
        if(StrUtil.isNotBlank(orderListParams.getState())){
            queryWrapper.eq("o.state",orderListParams.getState());
        }
        IPage<OrdersVo> result = ordersService.selectOrderByPage(page,queryWrapper);
    ...
    @ApiOperationSupport(author = "zpc")
    public ApiResultResponse<List<Orders>> pageAndOrder(
        ...
        IPage<Orders> result = ordersService.page(page);
        return ApiResultResponse.page(result);
    }
    ...
    @ApiOperationSupport(author = "zpc")
    public ApiResultResponse<Orders> getById(@PathVariable @NotNull(message = "ID不能为空") String id) {
    ...
    public ApiResultResponse<Boolean> save(
            @RequestBody @Valid Orders orders) {
    ...
    @ApiOperationSupport(author = "zpc")
    public ApiResultResponse<List<OrdersVo>> selectUserOrderByUserId(@PathVariable @NotNull(message = "用户ID不能为空") Integer userId) {
        return ApiResultResponse.list(this.ordersService.selectOrderByUserId(userId));
    }
}
